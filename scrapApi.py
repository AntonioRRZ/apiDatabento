...
def __getattr__(name: str) -> Any:
    """Ayuda a Jupyter a recuperar exports recientes tras recargas parciales.

    En cuadernos es frecuente que el módulo ya esté importado antes de añadir una
    nueva clase. Si el atributo solicitado no existe, se recarga el módulo para
    exponer los símbolos actuales y se devuelve el atributo solicitado si está
    disponible.
    """

    if name in {"SPASidebarExtractor", "SidebarLink", "RenderedPage", "SPADOMRenderer"}:
        import importlib
        import sys
